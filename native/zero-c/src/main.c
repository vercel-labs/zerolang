...
static const StdHelperInfo std_helpers[] = {
  ...
  {"std.json.root", "JsonNode", 1, "parse", "target-neutral", "borrows parsed arena tree", false},
  {"std.json.kind", "JsonKind", 1, "parse", "target-neutral", "no allocation", false},
  {"std.json.get", "Maybe<JsonNode>", 2, "parse", "target-neutral", "borrows parsed arena tree", false},
  {"std.json.at", "Maybe<JsonNode>", 2, "parse", "target-neutral", "borrows parsed arena tree", false},
  {"std.json.len", "usize", 1, "parse", "target-neutral", "no allocation", false},
  {"std.json.string", "Maybe<usize>", 2, "parse", "target-neutral", "writes caller buffer", false},
  {"std.json.int", "Maybe<i64>", 1, "parse", "target-neutral", "no allocation", false},
  {"std.json.float", "Maybe<f64>", 1, "parse", "target-neutral", "no allocation", false},
  {"std.json.bool", "Maybe<Bool>", 1, "parse", "target-neutral", "no allocation", false},
