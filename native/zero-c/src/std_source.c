...
static const ZStdSourceModule std_source_modules[] = {
  ...
  {"std.diag", "std/diag.0", zero_embedded_stdlib_graph_std_diag_graph_bytes, sizeof(zero_embedded_stdlib_graph_std_diag_graph_bytes)},
  ...
  {"std.term", "std/term.0", zero_embedded_stdlib_graph_std_term_graph_bytes, sizeof(zero_embedded_stdlib_graph_std_term_graph_bytes)},
...
static const ZStdSourceCall std_source_calls[] = {
  ...
  {"std.diag.column", "diag_column", "std.diag"},
  {"std.diag.formatLocation", "diag_format_location", "std.diag"},
  {"std.diag.formatOffsetLocation", "diag_format_offset_location", "std.diag"},
  {"std.diag.line", "diag_line", "std.diag"},
  {"std.diag.lineEnd", "diag_line_end", "std.diag"},
  {"std.diag.lineStart", "diag_line_start", "std.diag"},
  ...
  {"std.cli.formatCommand", "__zero_std_cli_format_command", "std.cli"}, {"std.cli.formatError", "__zero_std_cli_format_error", "std.cli"},
  {"std.cli.formatHelp", "__zero_std_cli_format_help", "std.cli"}, {"std.cli.formatHelpRow", "__zero_std_cli_format_help_row", "std.cli"},
  {"std.cli.formatHelpRowCustom", "__zero_std_cli_format_help_row_custom", "std.cli"}, {"std.cli.formatHelpRowWithWidth", "__zero_std_cli_format_help_row_with_width", "std.cli"},
  {"std.cli.formatInvalidOption", "__zero_std_cli_format_invalid_option", "std.cli"}, {"std.cli.formatMissingOperand", "__zero_std_cli_format_missing_operand", "std.cli"},
  {"std.cli.formatOption", "__zero_std_cli_format_option", "std.cli"}, {"std.cli.formatSection", "__zero_std_cli_format_section", "std.cli"},
  {"std.cli.formatUnknownCommand", "__zero_std_cli_format_unknown_command", "std.cli"},
  {"std.cli.formatUsage", "__zero_std_cli_format_usage", "std.cli"},
  {"std.cli.isHelp", "__zero_std_cli_is_help", "std.cli"},
  {"std.cli.needsHelp", "__zero_std_cli_needs_help", "std.cli"},
  ...
  {"std.http.contentTypeForPath", "__zero_std_http_content_type_for_path", "std.http"},
  {"std.http.headerBlockSafe", "__zero_std_http_header_block_safe", "std.http"},
  {"std.http.headerBytes", "__zero_std_http_header_bytes", "std.http"},
  {"std.http.errorName", "__zero_std_http_error_name", "std.http"},
  {"std.http.methodAllowed", "__zero_std_http_method_allowed", "std.http"},
  {"std.http.pathMatchesPattern", "__zero_std_http_path_matches_pattern", "std.http"},
  {"std.http.pathParam", "__zero_std_http_path_param", "std.http"},
  ...
  {"std.http.requestAccepts", "__zero_std_http_request_accepts", "std.http"},
  {"std.http.requestAcceptsJson", "__zero_std_http_request_accepts_json", "std.http"},
  ...
  {"std.http.requestContentLength", "__zero_std_http_request_content_length", "std.http"},
  {"std.http.requestContentType", "__zero_std_http_request_content_type", "std.http"},
  ...
  {"std.http.requestJsonField", "__zero_std_http_request_json_field", "std.http"},
  {"std.http.requestMatches", "__zero_std_http_request_matches", "std.http"},
  {"std.http.requestMethodAllowed", "__zero_std_http_request_method_allowed", "std.http"},
  ...
  {"std.http.requestPathParam", "__zero_std_http_request_path_param", "std.http"},
  ...
  {"std.http.requestRouteMethodAllowed", "__zero_std_http_request_route_method_allowed", "std.http"},
  {"std.http.requestRouteMatches", "__zero_std_http_request_route_matches", "std.http"},
  ...
  {"std.http.responseBodyEquals", "__zero_std_http_response_body_equals", "std.http"},
  {"std.http.responseBodyBytes", "__zero_std_http_response_body_bytes", "std.http"},
  {"std.http.responseContentType", "__zero_std_http_response_content_type", "std.http"},
  {"std.http.responseHeader", "__zero_std_http_response_header", "std.http"},
  {"std.http.responseMatches", "__zero_std_http_response_matches", "std.http"},
  {"std.http.responseRedirectLocation", "__zero_std_http_response_redirect_location", "std.http"},
  {"std.http.responseStatus", "__zero_std_http_response_status", "std.http"},
  {"std.http.responseStatusIs", "__zero_std_http_response_status_is", "std.http"},
  {"std.http.statusReason", "__zero_std_http_status_reason", "std.http"},
  {"std.http.testJsonRequest", "__zero_std_http_test_json_request", "std.http"},
  {"std.http.testRequest", "__zero_std_http_test_request", "std.http"},
  ...
  {"std.http.writeDeleteRequest", "__zero_std_http_write_delete_request", "std.http"},
  {"std.http.writeFound", "__zero_std_http_write_found", "std.http"},
  {"std.http.writeGetRequest", "__zero_std_http_write_get_request", "std.http"},
  {"std.http.writeHeadRequest", "__zero_std_http_write_head_request", "std.http"},
  ...
  {"std.http.writeJsonMethodRequest", "__zero_std_http_write_json_method_request", "std.http"},
  {"std.http.writeJsonRequest", "__zero_std_http_write_json_request", "std.http"},
  {"std.http.writeJsonRequestWithHeader", "__zero_std_http_write_json_request_with_header", "std.http"},
  {"std.http.writeJsonRequestWithHeaders", "__zero_std_http_write_json_request_with_headers", "std.http"},
  {"std.http.writeJsonResponseWithCookie", "__zero_std_http_write_json_response_with_cookie", "std.http"},
  {"std.http.writeJsonResponseWithHeader", "__zero_std_http_write_json_response_with_header", "std.http"},
  {"std.http.writeJsonResponseWithHeaders", "__zero_std_http_write_json_response_with_headers", "std.http"},
  ...
  {"std.http.writeMethodRequest", "__zero_std_http_write_method_request", "std.http"},
  ...
  {"std.http.writePatchJsonRequest", "__zero_std_http_write_patch_json_request", "std.http"},
  {"std.http.writePermanentRedirect", "__zero_std_http_write_permanent_redirect", "std.http"},
  {"std.http.writePostJsonRequest", "__zero_std_http_write_post_json_request", "std.http"},
  {"std.http.writePutJsonRequest", "__zero_std_http_write_put_json_request", "std.http"},
  ...
  {"std.http.writeRequestWithHeader", "__zero_std_http_write_request_with_header", "std.http"},
  {"std.http.writeRequestWithHeaders", "__zero_std_http_write_request_with_headers", "std.http"},
  {"std.http.writeResponse", "__zero_std_http_write_response", "std.http"},
  {"std.http.writeResponseWithHeader", "__zero_std_http_write_response_with_header", "std.http"},
  {"std.http.writeResponseWithHeaders", "__zero_std_http_write_response_with_headers", "std.http"},
  {"std.http.writeSeeOther", "__zero_std_http_write_see_other", "std.http"},
  {"std.http.writeStaticResponse", "__zero_std_http_write_static_response", "std.http"},
  ...
  {"std.json.errorColumn", "__zero_std_json_error_column", "std.json"},
  {"std.json.errorExpected", "__zero_std_json_error_expected", "std.json"},
  {"std.json.errorName", "__zero_std_json_error_name", "std.json"},
  {"std.json.errorLine", "__zero_std_json_error_line", "std.json"},
  {"std.json.errorOffset", "__zero_std_json_error_offset", "std.json"},
  ...
  {"std.log.levelDebug", "__zero_std_log_level_debug", "std.log"},
  {"std.log.levelError", "__zero_std_log_level_error", "std.log"},
  {"std.log.levelInfo", "__zero_std_log_level_info", "std.log"},
  {"std.log.levelWarn", "__zero_std_log_level_warn", "std.log"},
  {"std.log.message", "__zero_std_log_message", "std.log"},
  {"std.log.messageField", "__zero_std_log_message_field", "std.log"},
  {"std.log.redacted", "__zero_std_log_redacted", "std.log"},
  {"std.log.stringField", "__zero_std_log_string_field", "std.log"},
  ...
  {"std.inet.writeIpv4", "__zero_std_inet_write_ipv4", "std.inet"},
  {"std.inet.isIpv4Unspecified", "__zero_std_inet_is_ipv4_unspecified", "std.inet"},
  {"std.inet.isIpv4Loopback", "__zero_std_inet_is_ipv4_loopback", "std.inet"},
  {"std.inet.isIpv4Private", "__zero_std_inet_is_ipv4_private", "std.inet"},
  {"std.inet.isIpv4LinkLocal", "__zero_std_inet_is_ipv4_link_local", "std.inet"},
  {"std.inet.isIpv4Multicast", "__zero_std_inet_is_ipv4_multicast", "std.inet"},
  {"std.inet.isIpv6", "__zero_std_inet_is_ipv6", "std.inet"},
  {"std.inet.parseIpv6", "__zero_std_inet_parse_ipv6", "std.inet"},
  {"std.inet.isIp", "__zero_std_inet_is_ip", "std.inet"},
  {"std.inet.parseIp", "__zero_std_inet_parse_ip", "std.inet"},
  {"std.inet.isIpv6Unspecified", "__zero_std_inet_is_ipv6_unspecified", "std.inet"},
  {"std.inet.isIpv6Loopback", "__zero_std_inet_is_ipv6_loopback", "std.inet"},
  {"std.inet.isIpv6Multicast", "__zero_std_inet_is_ipv6_multicast", "std.inet"},
  {"std.inet.isIpv6LinkLocal", "__zero_std_inet_is_ipv6_link_local", "std.inet"},
  {"std.inet.isIpv6Private", "__zero_std_inet_is_ipv6_private", "std.inet"},
  {"std.inet.isIpv6UniqueLocal", "__zero_std_inet_is_ipv6_unique_local", "std.inet"},
  {"std.inet.isIpv6MappedIpv4", "__zero_std_inet_is_ipv6_mapped_ipv4", "std.inet"},
  {"std.inet.ipv6MappedIpv4", "__zero_std_inet_ipv6_mapped_ipv4", "std.inet"},
  ...
  {"std.testing.caseName", "__zero_std_testing_case_name", "std.testing"},
  {"std.testing.containsBytes", "__zero_std_testing_contains_bytes", "std.testing"},
  {"std.testing.diffIndexBytes", "__zero_std_testing_diff_index_bytes", "std.testing"},
  ...
  {"std.testing.jsonFieldEquals", "__zero_std_testing_json_field_equals", "std.testing"},
  {"std.testing.jsonPathEquals", "__zero_std_testing_json_path_equals", "std.testing"},
  {"std.testing.notEqualBytes", "__zero_std_testing_not_equal_bytes", "std.testing"},
  {"std.testing.startsWith", "__zero_std_testing_starts_with", "std.testing"},
  {"std.term.cursorTo", "term_cursor_to", "std.term"},
  {"std.term.cursorUp", "term_cursor_up", "std.term"},
  {"std.term.cursorDown", "term_cursor_down", "std.term"},
  {"std.term.cursorRight", "term_cursor_right", "std.term"},
  {"std.term.cursorLeft", "term_cursor_left", "std.term"},
  ...
  {"std.time.deadlineAfter", "__zero_std_time_deadline_after", "std.time"},
  {"std.time.remainingUntil", "__zero_std_time_remaining_until", "std.time"},
  {"std.time.deadlineExpired", "__zero_std_time_deadline_expired", "std.time"},
  ...
  {"std.time.writeDurationNs", "__zero_std_time_write_duration_ns", "std.time"},
  {"std.time.writeDurationMs", "__zero_std_time_write_duration_ms", "std.time"},
  {"std.time.writeDurationSeconds", "__zero_std_time_write_duration_seconds", "std.time"},
