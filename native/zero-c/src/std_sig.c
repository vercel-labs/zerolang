...
const ZStdHelperInfo z_std_helpers[] = {
  ...
  {"std.decimal.abs", "DecimalResult", 1, {"i64"}, {NULL}, "none", "target-neutral", "no allocation", true, Z_STD_HELPER_KIND_TABLE},
  {"std.decimal.add", "DecimalResult", 2, {"i64", "i64"}, {NULL}, "none", "target-neutral", "no allocation", true, Z_STD_HELPER_KIND_TABLE},
  {"std.decimal.cmp", "i32", 2, {"i64", "i64"}, {NULL}, "none", "target-neutral", "no allocation", true, Z_STD_HELPER_KIND_TABLE},
  {"std.decimal.div", "DecimalResult", 2, {"i64", "i64"}, {NULL}, "none", "target-neutral", "no allocation", true, Z_STD_HELPER_KIND_TABLE},
  {"std.decimal.mul", "DecimalResult", 2, {"i64", "i64"}, {NULL}, "none", "target-neutral", "no allocation", true, Z_STD_HELPER_KIND_TABLE},
  {"std.decimal.parse", "DecimalResult", 2, {"String", "u8"}, {NULL}, "none", "target-neutral", "no allocation", true, Z_STD_HELPER_KIND_TABLE},
  {"std.decimal.sub", "DecimalResult", 2, {"i64", "i64"}, {NULL}, "none", "target-neutral", "no allocation", true, Z_STD_HELPER_KIND_TABLE},
  {"std.decimal.toString", "Maybe<Span<u8>>", 3, {"MutSpan<u8>", "i64", "u8"}, {NULL}, "none", "target-neutral", "writes caller buffer", true, Z_STD_HELPER_KIND_TABLE},
