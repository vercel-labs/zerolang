...
const ZStdHelperInfo z_std_helpers[] = {
  ...
  {"std.zdn.parse", "Bool", 1, {"String"}, {NULL}, "memory", "target-neutral", "no allocation (validates only)", true, Z_STD_HELPER_KIND_TABLE},
  {"std.zdn.parseBytes", "Bool", 1, {"Span<u8>"}, {NULL}, "memory", "target-neutral", "no allocation (validates only)", true, Z_STD_HELPER_KIND_TABLE},
