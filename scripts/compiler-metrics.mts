...
const fileBudgets: Record<string, FileBudget> = {
  "native/zero-c/include/zero.h": { maxLines: 1259, maxStrcmpCalls: 0 },
  "native/zero-c/include/zero_contracts.h": { maxLines: 20, maxStrcmpCalls: 0 },
  "native/zero-c/include/zero_runtime.h": { maxLines: 234, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/checker.c": { maxLines: 12902, maxStrcmpCalls: 298 },
  ...
  "native/zero-c/src/main.c": { maxLines: 16561, maxStrcmpCalls: 453, maxShellCalls: 0 },
  "native/zero-c/src/ir.c": { maxLines: 5946, maxStrcmpCalls: 291 },
  ...
  "native/zero-c/src/buildability_context.c": { maxLines: 230, maxStrcmpCalls: 1 },
  "native/zero-c/src/buildability_targets.c": { maxLines: 186, maxStrcmpCalls: 0 },
  "native/zero-c/src/buildability_value_targets.c": { maxLines: 575, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/aarch64_direct.c": { maxLines: 1884, maxStrcmpCalls: 1 },
  ...
  "native/zero-c/src/emit_macho64.c": { maxLines: 3259, maxStrcmpCalls: 2 },
  "native/zero-c/src/emit_macho_x64.c": { maxLines: 2260, maxStrcmpCalls: 1 },
  ...
  "native/zero-c/src/emit_elf64.c": { maxLines: 3705, maxStrcmpCalls: 3 },
  ...
  "native/zero-c/src/emit_coff.c": { maxLines: 2346, maxStrcmpCalls: 1 },
  ...
  "native/zero-c/src/mir_verify.c": { maxLines: 2462, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/program_graph_mir.c": { maxLines: 5925, maxStrcmpCalls: 7 },
  ...
  "native/zero-c/src/std_sig.c": { maxLines: 744, maxStrcmpCalls: 2 },
  "native/zero-c/src/std_sig.h": { maxLines: 107, maxStrcmpCalls: 0 },
  "native/zero-c/src/std_source.c": { maxLines: 668, maxStrcmpCalls: 2 },
...
const knownLargeFunctionLimits = new Map([
  ...
  ["native/zero-c/src/ir.c|static bool ir_lower_expr(const Program *program, IrProgram *ir, const IrFunction *fun, const Expr *expr, IrValue **out) {", 1904],
  ["native/zero-c/src/capability_summary.c|static void ir_value_kind_capabilities(IrValueKind kind, CapabilitySummary *caps) {", 132],
  ...
  ["native/zero-c/src/emit_macho64.c|static bool macho_emit_value_to_reg_at(ZBuf *text, const IrFunction *fun, const IrValue *value, unsigned reg, unsigned frame_size, unsigned scratch_slot, MachOEmitContext *ctx, ZDiag *diag) {", 179],
  ["native/zero-c/src/program_graph_mir.c|static bool ir_graph_lower_std_byte_call(const ZProgramGraph *graph, IrProgram *ir, const IrFunction *fun, const ZProgramGraphNode *expr, const char *callee_name, size_t arg_count, bool *handled, IrValue **out) {", 770],
  ...
  ["native/zero-c/src/mir_verify.c|static bool mir_verify_direct_helper_value_contract(IrProgram *ir, const IrFunction *fun, const MirVerifierState *state, const IrValue *value, MirHelperRequirements *requirements) {", 331],
  ...
  ["native/zero-c/src/mir_verify.c|static bool mir_verify_direct_value_kind_contract(IrProgram *ir, const IrFunction *fun, const MirVerifierState *state, const IrValue *value, MirHelperRequirements *requirements) {", 160],
  ...
  ["native/zero-c/src/buildability_context.c|const char *z_build_value_kind_name(IrValueKind kind) {", 126],
