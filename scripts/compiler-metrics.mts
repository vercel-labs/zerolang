...
const fileBudgets: Record<string, FileBudget> = {
  ...
  "native/zero-c/src/main.c": { maxLines: 16783, maxStrcmpCalls: 454, maxShellCalls: 0 },
  "native/zero-c/src/ir.c": { maxLines: 6821, maxStrcmpCalls: 333 },
  ...
  "native/zero-c/src/buildability_value_support.c": { maxLines: 237, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/buildability_context.c": { maxLines: 249, maxStrcmpCalls: 1 },
  ...
  "native/zero-c/src/capability_summary.c": { maxLines: 205, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/elf_emit_state.c": { maxLines: 221, maxStrcmpCalls: 0 },
  "native/zero-c/src/elf_emit_state.h": { maxLines: 153, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/aarch64_direct.c": { maxLines: 2454, maxStrcmpCalls: 1 },
  ...
  "native/zero-c/src/emit_coff.c": { maxLines: 2861, maxStrcmpCalls: 1 },
  ...
  "native/zero-c/src/mir_verify.c": { maxLines: 2798, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/program_graph_mir.c": { maxLines: 6895, maxStrcmpCalls: 7 },
  ...
  "native/zero-c/src/std_sig.c": { maxLines: 1126, maxStrcmpCalls: 2 },
...
const knownLargeFunctionLimits = new Map([
  ...
  ["native/zero-c/src/capability_summary.c|static void ir_value_kind_capabilities(IrValueKind kind, CapabilitySummary *caps) {", 150],
  ...
  ["native/zero-c/src/emit_macho64.c|static bool macho_emit_value_to_reg_at(ZBuf *text, const IrFunction *fun, const IrValue *value, unsigned reg, unsigned frame_size, unsigned scratch_slot, MachOEmitContext *ctx, ZDiag *diag) {", 230],
  ...
  ["native/zero-c/src/main.c|static void runtime_import_audit_value(const IrValue *value, RuntimeImportAudit *audit) {", 242],
  ...
  ["native/zero-c/src/buildability_context.c|const char *z_build_value_kind_name(IrValueKind kind) {", 145],
