...
const fileBudgets: Record<string, FileBudget> = {
  "native/zero-c/include/zero.h": { maxLines: 1326, maxStrcmpCalls: 0 },
  "native/zero-c/include/zero_contracts.h": { maxLines: 20, maxStrcmpCalls: 0 },
  "native/zero-c/include/zero_runtime.h": { maxLines: 312, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/main.c": { maxLines: 16726, maxStrcmpCalls: 454, maxShellCalls: 0 },
  "native/zero-c/src/ir.c": { maxLines: 6555, maxStrcmpCalls: 333 },
  ...
  "native/zero-c/src/buildability_value_support.c": { maxLines: 234, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/buildability_context.c": { maxLines: 247, maxStrcmpCalls: 1 },
  "native/zero-c/src/buildability_targets.c": { maxLines: 189, maxStrcmpCalls: 0 },
  "native/zero-c/src/buildability_value_targets.c": { maxLines: 677, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/capability_summary.c": { maxLines: 203, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/coff_emit_state.c": { maxLines: 201, maxStrcmpCalls: 0 },
  "native/zero-c/src/coff_emit_state.h": { maxLines: 119, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/elf_emit_state.c": { maxLines: 210, maxStrcmpCalls: 0 },
  "native/zero-c/src/elf_emit_state.h": { maxLines: 142, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/aarch64_direct.c": { maxLines: 2379, maxStrcmpCalls: 1 },
  "native/zero-c/src/aarch64_direct.h": { maxLines: 100, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/emit_macho64.c": { maxLines: 3845, maxStrcmpCalls: 2 },
  "native/zero-c/src/emit_macho_x64.c": { maxLines: 2791, maxStrcmpCalls: 1 },
  "native/zero-c/src/macho_emit_state.c": { maxLines: 267, maxStrcmpCalls: 0 },
  "native/zero-c/src/macho_emit_state.h": { maxLines: 152, maxStrcmpCalls: 0 },
  "native/zero-c/src/emit_elf64.c": { maxLines: 4227, maxStrcmpCalls: 3 },
  "native/zero-c/src/emit_elf_aarch64.c": { maxLines: 500, maxStrcmpCalls: 1 },
  "native/zero-c/src/emit_llvm_ir.c": { maxLines: 1016, maxStrcmpCalls: 9 },
  "native/zero-c/src/emit_coff.c": { maxLines: 2781, maxStrcmpCalls: 1 },
  "native/zero-c/src/emit_coff_aarch64.c": { maxLines: 531, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/mir_verify.c": { maxLines: 2754, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/program_graph_mir.c": { maxLines: 6660, maxStrcmpCalls: 7 },
  ...
  "native/zero-c/src/std_sig.c": { maxLines: 1042, maxStrcmpCalls: 2 },
...
const knownLargeFunctionLimits = new Map([
  ...
  ["native/zero-c/src/capability_summary.c|static void ir_value_kind_capabilities(IrValueKind kind, CapabilitySummary *caps) {", 148],
  ...
  ["native/zero-c/src/emit_macho64.c|static bool macho_emit_value_to_reg_at(ZBuf *text, const IrFunction *fun, const IrValue *value, unsigned reg, unsigned frame_size, unsigned scratch_slot, MachOEmitContext *ctx, ZDiag *diag) {", 228],
  ["native/zero-c/src/program_graph_mir.c|static bool ir_graph_lower_std_byte_call(const ZProgramGraph *graph, IrProgram *ir, const IrFunction *fun, const ZProgramGraphNode *expr, const char *callee_name, size_t arg_count, bool *handled, IrValue **out) {", 795],
  ...
  ["native/zero-c/src/main.c|static void runtime_import_audit_value(const IrValue *value, RuntimeImportAudit *audit) {", 221],
  ...
  ["native/zero-c/src/buildability_context.c|const char *z_build_value_kind_name(IrValueKind kind) {", 143],
  ...
  ["native/zero-c/src/ir.c|static bool ir_lower_std_proc_direct_call(const Program *program, IrProgram *ir, const IrFunction *fun, const Expr *call, IrDirectStdCallId id, bool *handled, IrValue **out) {", 144],
