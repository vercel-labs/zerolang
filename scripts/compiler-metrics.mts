...
const fileBudgets: Record<string, FileBudget> = {
  "native/zero-c/include/zero.h": { maxLines: 1302, maxStrcmpCalls: 0 },
  "native/zero-c/include/zero_contracts.h": { maxLines: 20, maxStrcmpCalls: 0 },
  "native/zero-c/include/zero_runtime.h": { maxLines: 275, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/main.c": { maxLines: 16695, maxStrcmpCalls: 454, maxShellCalls: 0 },
  "native/zero-c/src/ir.c": { maxLines: 6457, maxStrcmpCalls: 333 },
  ...
  "native/zero-c/src/buildability_value_support.c": { maxLines: 218, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/buildability_context.c": { maxLines: 243, maxStrcmpCalls: 1 },
  "native/zero-c/src/buildability_targets.c": { maxLines: 189, maxStrcmpCalls: 0 },
  "native/zero-c/src/buildability_value_targets.c": { maxLines: 665, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/capability_summary.c": { maxLines: 199, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/coff_emit_state.c": { maxLines: 196, maxStrcmpCalls: 0 },
  "native/zero-c/src/coff_emit_state.h": { maxLines: 114, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/elf_emit_state.c": { maxLines: 205, maxStrcmpCalls: 0 },
  "native/zero-c/src/elf_emit_state.h": { maxLines: 137, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/aarch64_direct.c": { maxLines: 2313, maxStrcmpCalls: 1 },
  "native/zero-c/src/aarch64_direct.h": { maxLines: 95, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/emit_macho64.c": { maxLines: 3700, maxStrcmpCalls: 2 },
  "native/zero-c/src/emit_macho_x64.c": { maxLines: 2705, maxStrcmpCalls: 1 },
  "native/zero-c/src/macho_emit_state.c": { maxLines: 258, maxStrcmpCalls: 0 },
  "native/zero-c/src/macho_emit_state.h": { maxLines: 143, maxStrcmpCalls: 0 },
  "native/zero-c/src/emit_elf64.c": { maxLines: 4139, maxStrcmpCalls: 3 },
  "native/zero-c/src/emit_elf_aarch64.c": { maxLines: 495, maxStrcmpCalls: 1 },
  "native/zero-c/src/emit_llvm_ir.c": { maxLines: 1016, maxStrcmpCalls: 9 },
  "native/zero-c/src/emit_coff.c": { maxLines: 2687, maxStrcmpCalls: 1 },
  "native/zero-c/src/emit_coff_aarch64.c": { maxLines: 526, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/mir_verify.c": { maxLines: 2675, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/program_graph_mir.c": { maxLines: 6572, maxStrcmpCalls: 7 },
  ...
  "native/zero-c/src/std_sig.c": { maxLines: 1028, maxStrcmpCalls: 2 },
...
const knownLargeFunctionLimits = new Map([
  ...
  ["native/zero-c/src/emit_macho64.c|static bool macho_emit_value_to_reg_at(ZBuf *text, const IrFunction *fun, const IrValue *value, unsigned reg, unsigned frame_size, unsigned scratch_slot, MachOEmitContext *ctx, ZDiag *diag) {", 209],
  ...
  ["native/zero-c/src/main.c|static void runtime_import_audit_value(const IrValue *value, RuntimeImportAudit *audit) {", 209],
  ...
  ["native/zero-c/src/mir_verify.c|static bool mir_verify_direct_value_kind_contract(IrProgram *ir, const IrFunction *fun, const MirVerifierState *state, const IrValue *value, MirHelperRequirements *requirements) {", 173],
  ...
  ["native/zero-c/src/buildability_context.c|const char *z_build_value_kind_name(IrValueKind kind) {", 139],
