...
const fileBudgets = {
  ...
  "native/zero-c/src/checker.c": { maxLines: 9400, maxStrcmpCalls: 404 },
  "native/zero-c/src/main.c": { maxLines: 10045, maxStrcmpCalls: 544 },
  "native/zero-c/src/ir.c": { maxLines: 3700, maxStrcmpCalls: 225 },
  ...
  "native/zero-c/src/emit_macho64.c": { maxLines: 1560, maxStrcmpCalls: 2 },
...
const knownLargeFunctionLimits = new Map([
  ["native/zero-c/src/ir.c|static bool ir_lower_expr(const Program *program, IrProgram *ir, const IrFunction *fun, const Expr *expr, IrValue **out) {", 1505],
  ...
  ["native/zero-c/src/emit_elf64.c|static bool elf_emit_value(ZBuf *code, const IrFunction *fun, const IrValue *value, ElfEmitContext *ctx, ZDiag *diag) {", 1090],
  ...
  ["native/zero-c/src/emit_macho64.c|static bool macho_emit_value_to_reg_at(ZBuf *text, const IrFunction *fun, const IrValue *value, unsigned reg, unsigned frame_size, unsigned scratch_slot, MachOEmitContext *ctx, ZDiag *diag) {", 435],
  ...
  ["native/zero-c/src/checker.c|static const char *std_call_arg_type(const char *name, size_t index) {", 141],
  ["native/zero-c/src/mir_verify.c|static bool mir_verify_direct_value_kind_contract(IrProgram *ir, const IrFunction *fun, const MirVerifierState *state, const IrValue *value, MirHelperRequirements *requirements) {", 136],
