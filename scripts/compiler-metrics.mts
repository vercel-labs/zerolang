...
const fileBudgets: Record<string, FileBudget> = {
  "native/zero-c/include/zero.h": { maxLines: 1291, maxStrcmpCalls: 0 },
  "native/zero-c/include/zero_contracts.h": { maxLines: 20, maxStrcmpCalls: 0 },
  "native/zero-c/include/zero_runtime.h": { maxLines: 263, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/main.c": { maxLines: 16686, maxStrcmpCalls: 454, maxShellCalls: 0 },
  "native/zero-c/src/ir.c": { maxLines: 6320, maxStrcmpCalls: 333 },
  ...
  "native/zero-c/src/buildability_value_support.c": { maxLines: 212, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/buildability_context.c": { maxLines: 241, maxStrcmpCalls: 1 },
  "native/zero-c/src/buildability_targets.c": { maxLines: 189, maxStrcmpCalls: 0 },
  "native/zero-c/src/buildability_value_targets.c": { maxLines: 636, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/capability_summary.c": { maxLines: 198, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/coff_emit_state.c": { maxLines: 194, maxStrcmpCalls: 0 },
  "native/zero-c/src/coff_emit_state.h": { maxLines: 112, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/elf_emit_state.c": { maxLines: 203, maxStrcmpCalls: 0 },
  "native/zero-c/src/elf_emit_state.h": { maxLines: 135, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/aarch64_direct.c": { maxLines: 2265, maxStrcmpCalls: 1 },
  "native/zero-c/src/aarch64_direct.h": { maxLines: 93, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/emit_macho64.c": { maxLines: 3652, maxStrcmpCalls: 2 },
  "native/zero-c/src/emit_macho_x64.c": { maxLines: 2670, maxStrcmpCalls: 1 },
  "native/zero-c/src/macho_emit_state.c": { maxLines: 256, maxStrcmpCalls: 0 },
  "native/zero-c/src/macho_emit_state.h": { maxLines: 141, maxStrcmpCalls: 0 },
  "native/zero-c/src/emit_elf64.c": { maxLines: 4103, maxStrcmpCalls: 3 },
  "native/zero-c/src/emit_elf_aarch64.c": { maxLines: 493, maxStrcmpCalls: 1 },
  "native/zero-c/src/emit_llvm_ir.c": { maxLines: 1016, maxStrcmpCalls: 9 },
  "native/zero-c/src/emit_coff.c": { maxLines: 2647, maxStrcmpCalls: 1 },
  "native/zero-c/src/emit_coff_aarch64.c": { maxLines: 524, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/mir_verify.c": { maxLines: 2611, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/program_graph_mir.c": { maxLines: 6438, maxStrcmpCalls: 7 },
  ...
  "native/zero-c/src/std_sig.c": { maxLines: 991, maxStrcmpCalls: 2 },
...
const knownLargeFunctionLimits = new Map([
  ...
  ["native/zero-c/src/capability_summary.c|static void ir_value_kind_capabilities(IrValueKind kind, CapabilitySummary *caps) {", 143],
  ...
  ["native/zero-c/src/emit_macho64.c|static bool macho_emit_value_to_reg_at(ZBuf *text, const IrFunction *fun, const IrValue *value, unsigned reg, unsigned frame_size, unsigned scratch_slot, MachOEmitContext *ctx, ZDiag *diag) {", 206],
  ...
  ["native/zero-c/src/mir_verify.c|static bool mir_verify_direct_helper_value_contract(IrProgram *ir, const IrFunction *fun, const MirVerifierState *state, const IrValue *value, MirHelperRequirements *requirements) {", 397],
  ...
  ["native/zero-c/src/buildability_context.c|const char *z_build_value_kind_name(IrValueKind kind) {", 137],
