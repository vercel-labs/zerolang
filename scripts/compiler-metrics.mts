...
const fileBudgets: Record<string, FileBudget> = {
  ...
  "native/zero-c/include/zero_runtime.h": { maxLines: 313, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/main.c": { maxLines: 16729, maxStrcmpCalls: 454, maxShellCalls: 0 },
  "native/zero-c/src/ir.c": { maxLines: 6557, maxStrcmpCalls: 333 },
  ...
  "native/zero-c/src/buildability_context.c": { maxLines: 248, maxStrcmpCalls: 1 },
  ...
  "native/zero-c/src/capability_summary.c": { maxLines: 204, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/emit_macho64.c": { maxLines: 3849, maxStrcmpCalls: 2 },
  "native/zero-c/src/emit_macho_x64.c": { maxLines: 2791, maxStrcmpCalls: 1 },
  "native/zero-c/src/macho_emit_state.c": { maxLines: 268, maxStrcmpCalls: 0 },
  "native/zero-c/src/macho_emit_state.h": { maxLines: 153, maxStrcmpCalls: 0 },
  "native/zero-c/src/emit_elf64.c": { maxLines: 4228, maxStrcmpCalls: 3 },
  ...
  "native/zero-c/src/mir_verify.c": { maxLines: 2758, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/program_graph_mir.c": { maxLines: 6662, maxStrcmpCalls: 7 },
  ...
  "native/zero-c/src/std_sig.c": { maxLines: 1044, maxStrcmpCalls: 2 },
  "native/zero-c/src/std_sig.h": { maxLines: 108, maxStrcmpCalls: 0 },
  "native/zero-c/src/std_source.c": { maxLines: 962, maxStrcmpCalls: 2 },
...
const knownLargeFunctionLimits = new Map([
  ...
  ["native/zero-c/src/capability_summary.c|static void ir_value_kind_capabilities(IrValueKind kind, CapabilitySummary *caps) {", 149],
  ...
  ["native/zero-c/src/main.c|static void runtime_import_audit_value(const IrValue *value, RuntimeImportAudit *audit) {", 222],
  ...
  ["native/zero-c/src/mir_verify.c|static bool mir_verify_direct_value_kind_contract(IrProgram *ir, const IrFunction *fun, const MirVerifierState *state, const IrValue *value, MirHelperRequirements *requirements) {", 175],
  ...
  ["native/zero-c/src/buildability_context.c|const char *z_build_value_kind_name(IrValueKind kind) {", 144],
