...
const fileBudgets: Record<string, FileBudget> = {
  ...
  "native/zero-c/include/zero_runtime.h": { maxLines: 300, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/buildability_value_support.c": { maxLines: 228, maxStrcmpCalls: 0 },
  ...
  "native/zero-c/src/emit_macho64.c": { maxLines: 3758, maxStrcmpCalls: 2 },
  "native/zero-c/src/emit_macho_x64.c": { maxLines: 2776, maxStrcmpCalls: 1 },
  "native/zero-c/src/macho_emit_state.c": { maxLines: 263, maxStrcmpCalls: 0 },
  "native/zero-c/src/macho_emit_state.h": { maxLines: 148, maxStrcmpCalls: 0 },
...
const knownLargeFunctionLimits = new Map([
  ...
  ["native/zero-c/src/emit_macho64.c|static bool macho_emit_value_to_reg_at(ZBuf *text, const IrFunction *fun, const IrValue *value, unsigned reg, unsigned frame_size, unsigned scratch_slot, MachOEmitContext *ctx, ZDiag *diag) {", 218],
